...
itemValidations.push({reg: itemNameRegEx, field: $('#txtItemName'), error: 'Item Name is a required field : Minimum 3, Max 20, Spaces Allowed'});
itemValidations.push({reg: itemUnitPriceRegEx, field: $('#txtItemQty'), error: 'Item Qty is a required field : Numbers'});
